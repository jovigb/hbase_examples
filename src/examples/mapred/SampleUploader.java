...
public class SampleUploader {
  ...
  extends Mapper<BytesWritable, Text, ImmutableBytesWritable, Put> {

    private long checkpoint = 100;
    private long count = 0;

    @Override
    public void map(BytesWritable key, Text line, Context context)
    throws IOException {
...
//      }
      ...
      byte [] qualifier = Bytes.toBytes("log");
      byte [] value = Bytes.toBytes(line.toString());
